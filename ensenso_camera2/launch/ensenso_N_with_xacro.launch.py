...
def launch_setup(context, *args, **kwargs):
    ...
    xacro_model_path = os.path.join(get_package_share_directory("ensenso_description"), "ensenso_N3x_Series.xacro")
    ...
    static_transform_publisher_node = Node(
        ...
        arguments=["0.05", "0.0", "-0.05," "0.0", "0.0", "0.0", "1.0", frame_id, xacro_reference_frame],
    )
