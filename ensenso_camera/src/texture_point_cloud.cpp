 ...
 */
ensenso::pcl::PointCloudColored::Ptr
texturePointCloudFromRectifiedImage(cv::Mat const& image, ensenso::pcl::PointCloud::ConstPtr const& pointCloud)
{
  auto texturedPointCloud = boost::make_shared<ensenso::pcl::PointCloudColored>();
...
private:
  ...
  ensenso::pcl::PointCloud::ConstPtr latestPointCloud;
...
public:
  TexturingNode()
  {
    ...
    texturedPointCloudPublisher = nodeHandle.advertise<ensenso::pcl::PointCloudColored>("textured_point_cloud", 1);
  }
...
private:
  ...
  void onPointCloudReceived(ensenso::pcl::PointCloud::ConstPtr const& pointCloud)
  {
    std::lock_guard<std::mutex> lock(mutex);
  ...
  void texture() const
  {
    ...
    ensenso::pcl::PointCloudColored::Ptr texturedPointCloud;
